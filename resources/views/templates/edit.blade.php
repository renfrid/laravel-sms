        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{ Form::open(['url' => route('templates.update', $template->id), 'method' => 'PUT', 'class' => 'form-horizontal']) }}
                    {{ Form::token() }}
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                {{ Form::text('name', old('name', $template->name), ['class="form-control"', 'placeholder="Write a template title..."']) }}
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                {{ Form::textarea('message', old('message', $template->message), ['class="form-control"', 'placeholder="Write template message..."', 'rows="3"']) }}
