    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Send Quick SMS</h4>
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Send Quick SMS</li>
                    </ol>
                </div>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Send Quick SMS</h4>
                ...
                <div class="card-body">
                    ...
                    {{ Form::open(['url' => route('sms-logs.send-quick-sms'), 'method' => 'POST', 'class' => 'form-horizontal']) }}
                    {{ Form::token() }}

                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">
                                <label>Phone Number (s) <span class="text-danger">*</span></label>
                                {{ Form::text('phone', old('phone'), ['class="form-control"', 'placeholder="Write a phone number(s) in comma-separated..."']) }}
