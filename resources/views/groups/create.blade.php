        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Create Contact Group</h4>
                ...
                <div class="card-body">
                    ...
                    {{ Form::open(['url' => route('contact-groups.store'), 'method' => 'POST', 'class' => 'form-horizontal']) }}
                    {{ Form::token() }}
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                {{ Form::text('name', old('name'), ['class="form-control"', 'placeholder="Write a  name..."']) }}
