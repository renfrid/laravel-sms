...
--
-- Database: sms_app_db
-- Generation Time: 2022-11-25 15:52:25.2070
-- -------------------------------------------------------------
...
CREATE TABLE `sms_logs` (
  ...
  `gateway_code` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `gateway_message` text CHARACTER SET utf8 COLLATE utf8_general_ci,
